...
import phone_call from '../icon/phone-call.png';
    ...
    <div className="body">
      ...
      <nav className="fixed-navbar">
        ...
        <div className="navbar-right">
          {/* <button className="nav-button" onClick={scrollToStory}>초대</button> */}
          <button
      ...
      <div className="body-middle" ref={invitationRef}>
        ...
        <div className="main-word">
          ...
          <br />
          <p>
            <img src={heart} alt="heart" style={{ width: '1.4rem', height: '1.45rem', verticalAlign: 'middle' }} />
            <br/>
            신랑 유민혁과 신부 이예진이<br/>
            감동을 나누고자합니다.<br/>
            사랑과 믿음 안에서 하나 되어<br/>
            ...
            저희의 시작에<br/>
            따뜻한 동행이 되어 주세요.<br/>
            <img src={heart} alt="heart" style={{ width: '1.4rem', height: '1.45rem', verticalAlign: 'middle' }} /><br/>
          </p>
        </div>
      </div>
      ...
      {/* <div className="our-story-section" ref={storyRef}>
        ...
        <div className="our-story">
          <p>
            ...
            서로를 ‘동기’라 부르며 인사하고,<br/>
            함께 웃으며 친구가 되었어요.<br/>
            멋지고 쾌활한 민혁이,<br/>
            예쁘고 수줍은 예진이.<br/>
            그렇게 풋풋하게 시작된 인연이었죠.<br/>
          </p>
        </div>
      ...
      <div className="parking-table-container">
        ...
        <div className='parking-number'>
          ...
          <a href="tel:051-636-7769" aria-label="전화 걸기">
            <img
              src={phone_call}
              alt="전화 아이콘"
